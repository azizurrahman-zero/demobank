...
const PdfUploadPage = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8080/api/v1/Files/uploadFile', formData);
  ...
  return (
    <div className="flex h-screen">
      <div className="flex flex-col flex-1 bg-gray-100 px-8 py-6">
        <h2 className="text-2xl font-semibold mb-4">Upload Documents to apply for a Loan</h2>
